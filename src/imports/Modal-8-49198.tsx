import svgPaths from "./svg-5m2foilixy";
...
function Frame9() {
  return (
    <div className="content-stretch flex flex-col gap-[8px] items-start relative shrink-0 w-full">
      <Frame7 />
      <p className="font-['Sage_Headline:Black',sans-serif] leading-[1.4] not-italic relative shrink-0 text-[32px] text-[rgba(255,255,255,0.95)] text-center w-full whitespace-pre-wrap">{`How many employees are in your company? `}</p>
    </div>
  );
}
...
function Frame8() {
  return <div className="bg-[#00d639] h-full rounded-[60px] shrink-0 w-[380px]" />;
}
...
function Frame5() {
  return (
    <div className="bg-[#303030] content-stretch flex flex-[1_0_0] gap-[10px] items-center min-h-px min-w-px relative rounded-[60px] w-full">
      <Frame8 />
      <div className="absolute left-[374px] size-[12px] top-[-3.5px]">
...
function MNOOffice() {
  return (
    <div className="overflow-clip relative shrink-0 size-[60px]" data-name="M N O/office">
...
function CtaStates() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[24px] items-center justify-center pb-[24px] pt-[40px] px-[24px] relative rounded-[8px] shrink-0 size-[200px]" data-name="CTA states">
      ...
      <MNOOffice />
      <p className="font-['Sage_Text:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[18px] text-center text-white w-[min-content] whitespace-pre-wrap">0-19 employees</p>
    </div>
  );
}

function PQRPeopleNetwork() {
  return (
    <div className="overflow-clip relative shrink-0 size-[60px]" data-name="P Q R/people-network">
      <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 60 60">
        <g id="surface1">
          <path d={svgPaths.p15ad6580} fill="var(--fill-0, white)" fillOpacity="0.9" id="Vector" />
        </g>
...
function CtaStates1() {
  return (
    <div className="bg-black content-stretch flex flex-col gap-[24px] items-center justify-center pb-[24px] pt-[40px] px-[24px] relative rounded-[8px] shrink-0 size-[200px]" data-name="CTA states">
      <div aria-hidden="true" className="absolute border-2 border-[#e2e2e2] border-solid inset-0 pointer-events-none rounded-[8px]" />
      <PQRPeopleNetwork />
      <p className="font-['Sage_Text:Regular',sans-serif] leading-[1.6] min-w-full not-italic relative shrink-0 text-[18px] text-center text-white w-[min-content] whitespace-pre-wrap">20+ employees</p>
    </div>
  );
}
...
function Frame10() {
  return (
    <div className="absolute content-stretch flex items-center left-0 p-[4px] rounded-[8px] top-[-4px]">
