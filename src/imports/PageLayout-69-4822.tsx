...
function Group8() {
  return (
    <div className="absolute contents left-[9.29px] top-[96.63px]">
      ...
      <div className="absolute flex h-[75.566px] items-center justify-center left-[48.31px] top-[122.13px] w-0" style={{ "--transform-inner-width": "1200", "--transform-inner-height": "19" } as React.CSSProperties}>
        <div className="flex-none rotate-90">
...
export default function PageLayout() {
  return (
    <div className="content-stretch flex flex-col items-start px-[240px] relative size-full" data-name="Page layout">
      <FlowLine />
      <Frame16 />
      <Flexbox />
    </div>
